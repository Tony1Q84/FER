...
if task == 'emotion':
    ...
    model_filename = '../trained_models/emotion_models/fer2013/fer2013_mini_XCEPTION.102-0.66.hdf5'
elif task == 'gender':
...
img = cv2.imread('../images/guided_gradCAM.png')
cv2.namedWindow('gradCAM_img', cv2.WINDOW_NORMAL)
cv2.resizeWindow('gradCAM_img', 880, 680)
cv2.imshow('gradCAM_img', img)
cv2.waitKey(0)
