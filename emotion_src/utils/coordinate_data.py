...
class CoordinateManager(object):
    ...
    def __init__(self, dataset_name = 'fer2013', dataset_path=None):
        ...
        if self.dataset_path != None:
            ...
            self.dataset_path = '../datasets/fer2013/dist_angle.csv'
        elif self.dataset_name == 'KDEF':
            self.dataset_path = '../datasets/KDEF/dist_angle.csv'
        elif self.dataset_name == 'CK+':
            self.dataset_path = '../datasets/CK+/dist_angle.csv'
        elif self.dataset_name == 'RAF':
            self.dataset_path = '../datasets/RAF/dist_angle.csv'
        elif self.dataset_name == 'SFEW':
            self.dataset_path = '../datasets/SFEW/dist_angle.csv'
        else:
