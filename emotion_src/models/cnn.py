...
from keras.layers import GlobalAveragePooling2D, ZeroPadding2D, Dense
...
def mini_LSTM(input_shape, num_classes):

    model = Sequential()
    model.add(LSTM(256, dropout=0.2, recurrent_dropout=0.2, return_sequences= True, input_shape=(input_shape)))
