...
class BilinearInterpolation(Layer):
    """Performs bilinear interpolation as a keras layer References
    ----------
    ...
    def _interpolate(self, image, sampled_grids, output_size):
        ...
        pixels_values_a = K.gather(flat_image, indices_a)
        pixels_valuse_b = K.gather(flat_image, indices_b)
        pixels_values_c = K.gather(flat_image, indices_c)
        pixels_values_d = K.gather(flat_image, indices_d)
        ...
        values_a = area_a * pixels_values_a
        values_b = area_b * pixels_valuse_b
        values_c = area_c * pixels_values_c
        values_d = area_d * pixels_values_d

        return values_a + values_b + values_c + values_d

    def _make_regular_grids(self, batch_size, height, width):
        # makeing a single regular grid
